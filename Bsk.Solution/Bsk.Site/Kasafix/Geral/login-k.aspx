<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login-k.aspx.cs" Inherits="Bsk.Site.Kasafix.Geral.loginkasafix" %>
        ...
        <button id="btnMensagem" runat="server" onserverclick="btnReenviar_ServerClick" class="btn" style="display: none; border: none;" disabled tabindex="-1">
            Reenviar email
                    ...
                    <div class="acessos">
                        ...
                        <button id="btnClienteKasafix" runat="server" onserverclick="btnCliente_ServerClick" class="btn">Entrar</button>
                    </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            document.getElementById("senhaCliente").addEventListener("keypress", function (event) {
                if (event.key === "Enter") {
                    document.getElementById("<%= btnClienteKasafix.ClientID %>").click(); // Simula o clique no botão de cliente
            }
        });
    });
