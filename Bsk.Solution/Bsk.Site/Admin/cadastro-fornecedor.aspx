<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cadastro-fornecedor.aspx.cs" Inherits="Bsk.Site.Admin.cadastro_fornecedor" MasterPageFile="~/Admin/Master/Layout.Master" %>
...
<asp:Content ContentPlaceHolderID="conteudo" ID="hd" runat="server"> 
   <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12 cadstro-site pd-0">
        <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="col col-lg-4 col-md-4 col-sm-12 col-sm-12 col-xs-12 mobile-pd-0">
                <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12 mobile-pd-0">
                    ...
                    <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12 pd-0">
                        ...
                        <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12"><h3>Dados básicos do fornecedor.</h3></div>

                        <!--################# ITEM ###################-->
                        <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12">&nbsp;</div>
                        <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12 dadosResponsavel">
                            <input type="text" class="form-control cnpj" id="cnpj" placeholder="CNPJ" runat="server">
                        </div>
                        <!--################# FIM ITEM ###################-->
                        ...
                        <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12">&nbsp;</div>
                        <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12 dadosResponsavel">
                            <input type="text" class="form-control" id="RazaoSocial" placeholder="Razão Social" runat="server">
                        </div>
                        <!--################# FIM ITEM ###################-->
                        ...
                        <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12">&nbsp;</div>
                        <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12 dadosResponsavel">
                            <input type="text" class="form-control" id="NomeFantasia" placeholder="Nome Fantasia" runat="server">
                        </div>
                        <!--################# FIM ITEM ###################-->
                        ...
                        <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12">&nbsp;</div>
                        <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12 dadosResponsavel">
                            <button class="btn btn-success" id="Status" runat="server" onserverclick="Status_ServerClick"></button>
                        </div>
                        <!--################# FIM ITEM ###################-->
                        ...
                        <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12">&nbsp;</div>
                        <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12 dadosResponsavel">
                            <input type="text" class="form-control" id="WhatsApp" placeholder="WhatsApp" runat="server">
                        </div>
                        <!--################# FIM ITEM ###################-->

                         <!--################# ITEM ###################-->
                        <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12">&nbsp;</div>
                        <div class="col col-lg-6 col-md-6 col-sm-6 col-xs-6 text-left">
                            <button class="btn btn-danger" id="btnDeletar" runat="server" onserverclick="btnDeletar_ServerClick"> Deletar </button>
                        </div>
                        <div class="col col-lg-6 col-md-6 col-sm-6 col-xs-6 text-right">
                            <button class="btn btn-success" id="btnSalvar" runat="server" onserverclick="btnSalvar_ServerClick"> Salvar </button>
                        </div>
                        <!--################# FIM ITEM ###################-->
        ...
        $(document).ready(function() {
            ...
            $("input.cpf").focusout(function() {
                ...
                if ($('input.cpf').val().length != 14) {
                    ...
                    $('.dadosResponsavel').find('.mensagem').remove();
                    $('#enderecoEmpresaPessoFisica').html('<div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12 pd-0 dadosRetira dadosPessoFisica" style="display: none;">                            <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12 ">                                <input type="text" class="form-control logradouro" id="logradouro" placeholder="Endereço">                            </div>                            <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12">&nbsp;</div>                            <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12 ">                                <div class="col col-lg-4 col-md-4 col-sm-12 col-sm-12 col-xs-12 pdl-0">                                    <input type="text" class="form-control cep" id="cep" placeholder="CEP">                                </div>      <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12 hidden-lg hidden-md">&nbsp;</div>                            <div class="col col-lg-4 col-md-4 col-sm-12 col-sm-12 col-xs-12 pdl-0">                                    <input type="text" class="form-control numero" id="numero" placeholder="Número">                                </div>         <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12 hidden-lg hidden-md">&nbsp;</div>                         <div class="col col-lg-4 col-md-4 col-sm-12 col-sm-12 col-xs-12 pdr-0">                                    <input type="text" class="form-control complemento" id="complemento" placeholder="Complemento">                                </div>                            </div>                            <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12">&nbsp;</div>                            <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12 ">                                <div class="col col-lg-4 col-md-4 col-sm-12 col-sm-12 col-xs-12 pdl-0">                                    <input type="text" class="form-control bairro" id="bairro" placeholder="Bairro">                                </div>  <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12 hidden-lg hidden-md">&nbsp;</div>                                <div class="col col-lg-4 col-md-4 col-sm-12 col-sm-12 col-xs-12 pdl-0">                                    <input type="text" class="form-control cidade" id="municipio" placeholder="Cidade">                                </div>       <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12 hidden-lg hidden-md">&nbsp;</div>                           <div class="col col-lg-4 col-md-4 col-sm-12 col-sm-12 col-xs-12 pdr-0">                                    <input type="text" class="form-control uf" id="uf" placeholder="UF">                                </div>                            </div>                            <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12">&nbsp;</div>                        </div>');
