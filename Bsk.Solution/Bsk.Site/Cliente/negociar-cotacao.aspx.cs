...
namespace Bsk.Site.Cliente
{
    ...
    public partial class negociar_cotacao : System.Web.UI.Page
    {
        ...
        public void CarregaCotacaoFornecedor()
        {
            ...
            if (cotacaoFornecedor != null)
            {
                if (cotacaoFornecedor.Novo == 1)
                {
                    ...
                    _core.CotacaoFornecedor_Update(cotacaoFornecedor, $" IdCotacao={Request.QueryString["Id"]}");
                }
                ...
                List<ParticipanteBE> forn = _core.Participante_Get(_ParticipanteBE," IdParticipante = " + cotacaoFornecedor.IdParticipante);
                ...
                if (cotacaoFornecedor != null)
                {
                    ...
                    var participante = _core.Participante_Get(_ParticipanteBE, $" IdParticipante={cotacaoFornecedor.IdParticipante.ToString()}").FirstOrDefault();
        ...
        private void mediaCotacoes()
        {
            ...
            var lista = _core.CotacaoListaGet(cotacaoFornecedor.IdSolicitacao.ToString());
            if (cotacao.IdCotacao != 0)
            {
                foreach (var item in lista)
                {
                    if (item.IdFornecedorDB == cotacaoFornecedor.IdCotacao)
                    {
        ...
        protected void btnEnviar_ServerClick(object sender, EventArgs e)
        {
            ...
            if (cotacaoFornecedor != null)
            {
                ...
                _CotacaoFornecedorChatBE.IdParticipante = 0; //cotacaoFornecedor.IdFornecedor; SEMPRE 0 PARA O QUE VAI RECEBER a MSG
                ...
                notif.visualizado = "0";
                notif.idfornecedor = cotacaoFornecedor.IdParticipante;
        ...
        public string pegaStatus()
        {
            ...
            if (cotacao.Status == "1")
            {
                return "cotacao-lista.aspx?Id=" + cotacao.IdSolicitacao;
            }
            else
            {
