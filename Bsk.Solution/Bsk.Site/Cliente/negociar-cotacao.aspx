            ...
            <div class="item_content_card ">
                ...
                <!--FIM CLIENTE-->";
                    ...
                    <div>
                        ...
                        <button type="button" class="btn enviar-cotacao" id="btnEnviarAnexo" clientidmode="Static" onserverclick="btnEnviarAnexo_ServerClick" runat="server" style="display: none">
                            Enviar anexo
